...
namespace BusinessLayer.ValidationRules
{
    public class BlogValidator :AbstractValidator<Blog>
    {
        public BlogValidator ()
        {
            ...
            RuleFor(x => x.BlogTitle).MaximumLength(50).WithMessage("Blog Title Must Be At Most 50 Characters");
            RuleFor(x => x.BlogContent).MinimumLength(100).WithMessage("Blog Content Must Be At Least 100 Characters");
